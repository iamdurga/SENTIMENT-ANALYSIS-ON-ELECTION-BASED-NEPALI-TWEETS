# -*- coding: utf-8 -*-
"""Experiment Algorithms: Nosample2

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1vGEc9IPjv3c1X_LeFUjAruqQY8ulaNDz
...
lower_bound = 3000
upper_bound = 16304
filtered_vdf = vdf[(vdf['counts'] >= lower_bound) & (vdf['counts'] <= upper_bound)]
#filtered_vdf = vdf[(vdf['counts']== lower_bound)]
vdf['term_frequency'] = vdf['counts'] / vdf['counts'].sum()

# Calculate Document Frequency (DF)
vdf['document_frequency'] = (vdf['counts'] > 0).astype(int)

# Display the DataFrame with TF and DF columns
print(vdf)

from sklearn.feature_extraction.text import TfidfTransformer
tfidf_transformer = TfidfTransformer(smooth_idf=False, norm=None)  # You can adjust parameters as needed
tfidf_matrix = tfidf_transformer.fit_transform(vdf[['term_frequency', 'document_frequency']])

# Create a DataFrame with TF-IDF values
tfidf_df = pd.DataFrame(tfidf_matrix.toarray(), columns=['tfidf_term_frequency', 'tfidf_document_frequency'])

# Concatenate the original DataFrame 'vdf' with the new DataFrame 'tfidf_df'
vdf = pd.concat([vdf, tfidf_df], axis=1)

# Display the DataFrame with TF, DF, and TF-IDF columns
print(vdf)
